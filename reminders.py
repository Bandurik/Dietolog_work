...
def start_scheduler():
    ...
    schedule.every().day.at("02:25").do(send_reminders_for_schedule, "7-00", "Не забудьте покушать Ужин!")
    ...
    schedule.every().day.at("02:20").do(send_reminders_for_schedule, "9-00", "Не забудьте выпить воды!")
    schedule.every().day.at("18:40").do(send_reminders_for_schedule, "9-00", "Не забудьте покушать Ужин!")

    # Ежедневное и еженедельное меню
    schedule.every().day.at("02:18").do(send_daily_menu)
