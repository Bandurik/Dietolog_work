...
from database import add_user, get_user, update_subscription, update_user_info, update_eating_schedule, delete_user
...
def subscribe(update: Update, context: CallbackContext):
    ...
    chat_id = query.message.chat_id
    payment_url = create_payment(500.00, "https://www.example.com/return_url", chat_id)
